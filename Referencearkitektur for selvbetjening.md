...
Referencearkitekturen baseres på standarder og standardsnitflader, hvoraf flere fastlægges i andre referencearkitekturer (se afsnittet om [sammenhæng til den fællesoffentlige rammearkitektur](/node/1100#sammenhng-til-den-fllesoffentlige-rammearkitektur)). De kommende års arbejde med referencearkitekturer, vil udvikle fællesoffentlige komponenter og omsætte referencearkitekturen til praksis. Der er derfor brug for et arbejde med mere konkrete standarder og vejledninger.
